...
module.exports = async (client) => {
    ...
    console.log(`\u001b[0m`);
    console.log(chalk.blue(chalk.bold(`System`)), (chalk.white(`>>`)), chalk.white(`Shard #${client.shard.ids[0] + 1}`), chalk.cyan(`is ready!`))
    console.log(chalk.blue(chalk.bold(`Bot`)), (chalk.white(`>>`)), chalk.cyan(`Started on`), chalk.white(`${client.guilds.cache.size}`), chalk.cyan(`servers!`))
