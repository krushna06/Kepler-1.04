...
async function connect() {
    ...
    try {
        console.log(chalk.blue(chalk.bold(`Database`)), (chalk.white(`>>`)), chalk.grey(`MongoDB`), chalk.grey(`is connecting...`))
    ...
    mongoose.connection.once("open", () => {
        console.log(chalk.blue(chalk.bold(`Database`)), (chalk.white(`>>`)), chalk.white(`MongoDB`), chalk.green(`is ready!`))
    });
