...
module.exports = (client) => {
    ...
    if (client.shard.ids[0] === 0) console.log(chalk.blue(chalk.bold(`System`)), (chalk.white(`>>`)), (chalk.grey(`Loading commands`)), (chalk.white(`...`)))
    ...
    fs.readdirSync('./src/interactions').forEach(dirs => {
        ...
        if (client.shard.ids[0] === 0) console.log(chalk.blue(chalk.bold(`System`)), (chalk.white(`>>`)), chalk.white(`${commandFiles.length}`), (chalk.cyan(`commands of`)), chalk.white(`${dirs}`), (chalk.cyan(`loaded`)));
